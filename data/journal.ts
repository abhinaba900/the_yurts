...
const articles: LocalPost[] = [
...

  {
    ...
    readingTime: 8,
    heroImage: {
      assetId: "/media/journal/Why yurts are transforming - landscape.webp",
      url: "/media/journal/Why yurts are transforming - landscape.webp",
      lqip: null,
      aspectRatio: 16 / 9,
      alt: "Why Yurts Are Transforming Luxury Glamping & Boutique Hospitality in India",
      caption: "Elevated Glamping Yurt on Forest Timber Deck",
    },
    verticalImage: {
      assetId: "/media/journal/Why yurts are transforming - vertical.webp",
      url: "/media/journal/Why yurts are transforming - vertical.webp",
      lqip: null,
      aspectRatio: 4 / 5,
      alt: "Why Yurts Are Transforming Luxury Glamping vertical view",
      caption: null,
    },
    author: {
...

  {
    ...
    readingTime: 8,
    heroImage: {
      assetId: "/media/journal/yurt vs traditional - horizontal.webp",
      url: "/media/journal/yurt vs traditional - horizontal.webp",
      lqip: null,
      aspectRatio: 16 / 9,
      alt: "Yurt vs. Traditional Construction: Capex, Speed and Site Impact",
      caption: "Light-Footprint Modular Construction on Sloped Land",
    },
    verticalImage: {
      assetId: "/media/journal/yurt vs traditional - Vertical.webp",
      url: "/media/journal/yurt vs traditional - Vertical.webp",
      lqip: null,
      aspectRatio: 4 / 5,
      alt: "Yurt vs. Traditional Construction vertical perspective",
      caption: null,
    },
    author: {
      name: "Theyurts Engineering Team",
...

  {
    ...
    readingTime: 9,
    heroImage: {
      assetId: "/media/journal/yurtz handle indian weather - horizontal.webp",
      url: "/media/journal/yurtz handle indian weather - horizontal.webp",
      lqip: null,
      aspectRatio: 16 / 9,
      alt: "Can Yurts Handle Indian Weather? Designing for Monsoon, Heat and Snow",
      caption: "High-Altitude Weather Resilience in Northern India",
    },
    verticalImage: {
      assetId: "/media/journal/yurtz handle indian weather - vertical.webp",
      url: "/media/journal/yurtz handle indian weather - vertical.webp",
      lqip: null,
      aspectRatio: 4 / 5,
      alt: "Weather resilient yurt vertical perspective",
      caption: null,
    },
    author: {
...

  {
    ...
    readingTime: 7,
    heroImage: {
      assetId: "/media/journal/Starting a glamping business - Horizontal.webp",
      url: "/media/journal/Starting a glamping business - Horizontal.webp",
      lqip: null,
      aspectRatio: 16 / 9,
      alt: "Starting a Glamping Business: What to Work Out Before You Build",
      caption: "A single structure, sited for the landscape around it",
    },
    verticalImage: {
      assetId: "/media/journal/Starting a glamping business - Vertical.webp",
      url: "/media/journal/Starting a glamping business - Vertical.webp",
      lqip: null,
      aspectRatio: 4 / 5,
      alt: "Starting a Glamping Business vertical view",
      caption: null,
    },
    author: {
...

  {
    ...
    readingTime: 10,
    heroImage: {
      assetId: "/media/journal/How to start - horizontal.webp",
      url: "/media/journal/How to start - horizontal.webp",
      lqip: null,
      aspectRatio: 16 / 9,
      alt: "How to Start a Glamping Business in India: From Land to First Guest",
      caption: "Boutique Guest Suite Interior & Amenities",
    },
    verticalImage: {
      assetId: "/media/journal/How to start - Vertical.webp",
      url: "/media/journal/How to start - Vertical.webp",
      lqip: null,
      aspectRatio: 4 / 5,
      alt: "How to Start a Glamping Business in India vertical perspective",
      caption: null,
    },
    author: {
      name: "Theyurts Hospitality Advisory",
...

  {
    ...
    readingTime: 7,
    heroImage: {
      assetId: "/media/journal/Navigating agricultural land - Horizontal.webp",
      url: "/media/journal/Navigating agricultural land - Horizontal.webp",
      lqip: null,
      aspectRatio: 16 / 9,
      alt: "Navigating Agricultural Land, Forest Clearings & Non-Permanent Permits in India",
      caption: "Zero-Excavation Farm Stay Accommodation",
    },
    verticalImage: {
      assetId: "/media/journal/Navigating agricultural land - Vertical.webp",
      url: "/media/journal/Navigating agricultural land - Vertical.webp",
      lqip: null,
      aspectRatio: 4 / 5,
      alt: "Navigating Agricultural Land & Permits vertical perspective",
      caption: null,
    },
    author: {
...

  {
    ...
    readingTime: 6,
    heroImage: {
      assetId: "/media/journal/The architecture of quiet - horizontal.webp",
      url: "/media/journal/The architecture of quiet - horizontal.webp",
      lqip: null,
      aspectRatio: 16 / 9,
      alt: "The Architecture of Quiet: Why Guests Pay a Premium for Circular Space & Acoustics",
      caption: "Column-Free Circular Sanctuary for Wellness & Rest",
    },
    verticalImage: {
      assetId: "/media/journal/The architecture of quiet - Vertical.webp",
      url: "/media/journal/The architecture of quiet - Vertical.webp",
      lqip: null,
      aspectRatio: 4 / 5,
      alt: "The Architecture of Quiet vertical perspective",
      caption: null,
    },
    author: {
...
const toSummary = (post: LocalPost): PostSummary => ({
  ...
  verticalImage: post.verticalImage ?? null,
  author: post.author,
